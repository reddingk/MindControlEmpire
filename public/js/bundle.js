    ...
    .factory("MCEData", ['$q', '$http', function($q, $http){
     function MCEInfoData() {
       ...
       vm.siteData = {
          ...
          "news":[
              {"title":"Gandhi Ali Live @ Basement Tuesday's", "date":new Date("2017-07-23 00:00:00"), "img":"imgs/media/basementEvent.jpg", "content":"Gandhi Ali will be performing Live at Pure Lounge's Basement Tuesday's.  This Tuesday, July 25 Doors open at 7pm, 21 and up, @ 1326 U Street, NW, DC", "tags":["GANDHI ALI","Basement Tuesday"]},
